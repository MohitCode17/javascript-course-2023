...
// In real world we cannot calculate or assume timing to execute the api request. May be one api takes 2 seconds or another may exeucte in 1 seconds it depends. We can't do such things in above code if we delay time the process will not same as we want. To do so callback function comes in the picture.
